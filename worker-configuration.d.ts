/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 96afbd5fe6beafa7d1f024bd41f126a6)
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOVA_API_KEY">> {
    }
}
