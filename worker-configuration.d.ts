/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d4929ed8db270c3d3524dbbf834b603d)
// Runtime types generated with workerd@1.20260131.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SkyMatchContainer";
	}
	interface Env {
		NOVA_API_KEY: string;
		...
		SKY_MATCH_CONTAINER: DurableObjectNamespace<import("./src/index").SkyMatchContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOVA_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_KV_NAMESPACE_ID" | "CLOUDFLARE_API_TOKEN">> {}
}
